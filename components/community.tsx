          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
              <input
                ...
                className="flex-1 rounded-full px-5 py-3 text-sm text-foreground placeholder:text-white/30 outline-none focus:ring-2 focus:ring-primary/50"
                style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)" }}
              />
              <Button
                type="submit"
                className="btn-glow rounded-full bg-primary text-white hover:bg-primary/90 px-6 py-3 text-sm h-auto whitespace-nowrap"
              >
                Join the Waitlist
              </Button>
            </form>
